...
function setup() {
  ...
  var bgImg = loadImage('../../graphics/background.png');
  img = loadImage("../../graphics/background.png");
  
  var imageObj = new Image();
  imageObj.src = '../../graphics/background.png';
...
function draw() {
    ...
    this.bgImg = loadImage('../../graphics/background.png');
 //background(220, 180, 200);
  ...
  //console.log( speedSpan.html(cycles));
